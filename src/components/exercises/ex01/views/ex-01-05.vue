<template lang="html">
  <div class="">
    <div class="font-sans container mx-auto p-4">
      <h2>Review</h2>
      ...
      <table class="w-full bg-white shadow-md tools-table">
        ...
        <tr class="border border-red" v-for="(item, index) in refinedList" v-bind:key="index">
          <td><input placeholder="Enter stakeholder name" class="shadow-inner rounded-sm p-2 w-full" @input="editStakeholder(index, $event.target.value)" type="text" name="" :value="item.name"></td>
          <td >
